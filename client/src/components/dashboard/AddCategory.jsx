...
import { add_category, get_all_category, messageClear } from '../../store/Reducers/categoryReducer';
...
const AddCategory = () => {
    ...
    const { loader, errorMessage, successMessage, allCategory, categoryCount } = useSelector(state => state.category);
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                                ...
                                <tbody>
                                    {
                                        allCategory && allCategory?.map((c, i) => {
                                            return <tr>
                                                ...
                                                <td>
                                                    <img className='productImgStyle' src={`${base_url}/categoryImg/${c?.categoryImage}`} alt="img" />
                                                </td>
                        ...
                        <div className="col-lg-4">
                            <h5 className="" style={{ backgroundColor: "#fff", padding: "13px 8px" }}>Add Category</h5>
                                        ...
                                        >
                                            {croppedImage ? (
                                                ...
                                                <>
                                                    ...
                                                    <span className='' style={{ height: "187px" }}>Select Image</span>
                                                </>
                                            )}
